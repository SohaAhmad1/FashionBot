...
public class Magpie4
{
  ...
  public Boolean state0, state1, state2, state3;
  int currState;
  ...
  //private int getState(num){
	//int nextState=0;
	//while (nextState<1 || nextState>3){
  ...
  public String YesResponce(String statement)
	{
  ...
  private void setState(int currState){
    ...
    state3=false;
   	...
   	switch(currState) {
     	case 1:
       	state1=true;
       	//System.out.println("Setting state 1 true, random question");
        System.out.print(YesResponce("hi"));
       	break;
      	case 2:
       	state2=true;
       	//System.out.println("Setting state 2 true, random responce");
        System.out.print(getRandomResponse());
       	break;
      	case 3:
       	state3=true;
        //System.out.println("Setting state 3 true, random fact");
        System.out.print(getRandomFact());
       	break;
     	default:
    	}
  }
